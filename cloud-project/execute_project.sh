...
hadoop jar ./target/cloud-project-1.0-SNAPSHOT.jar it.unipi.hadoop.LetterFrequency -D mapreduce.job.reduces=5 -D mapreduce.map.log.level=WARN "$NOME_DATASET" "$NOME_CARTELLA_OUTPUT"
